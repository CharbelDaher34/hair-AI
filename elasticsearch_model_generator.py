...
"""
    ...
    def populate_with_examples(self, model_instance: BaseModel = None) -> dict:
        ...
        for name, field_info in model_instance.model_fields.items():
            ...
            if isinstance(annotation, type) and issubclass(annotation, BaseModel):
                ...
                result[name] = self._get_example_value(annotation)
        return result
    ...
    def generate_filters_from_query(self, query: str):
        ...
        return client.parse() # Return the raw dictionary from the client
...
print(json.dumps(client.generate_filters_from_query("what did i spend my money last summer?, focus on tech and food expensive transactions more than 500"), indent=2))