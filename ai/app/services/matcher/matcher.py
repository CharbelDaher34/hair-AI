        ...
        for candidate in candidates:
            ...
            result = {
                ...
                "skill_analysis": {
                    ...
                    "matching_skills": skill_analysis['skill_analysis']['matching_skills'],
                    "missing_skills": skill_analysis['skill_analysis']['missing_skills'],
...
if __name__ == "__main__":
    ...
    for match in matches:
        ...
        print("\nSummary:")
        print(f"Total Required Skills: {match['skill_analysis']['summary']['total_required_skills']}")
        print(f"Matching Skills Count: {match['skill_analysis']['summary']['matching_skills_count']}")
        print(f"Missing Skills Count: {match['skill_analysis']['summary']['missing_skills_count']}")
        print(f"Extra Skills Count: {match['skill_analysis']['summary']['extra_skills_count']}")
        print("-" * 80)