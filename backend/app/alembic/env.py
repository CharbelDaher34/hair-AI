...
if not config.get_main_option("sqlalchemy.url"):
    config.set_main_option("sqlalchemy.url", str(settings.ADMIN_DATABASE_URL))

# Debug: Print the URL being used
print(f"Alembic using database URL: {config.get_main_option('sqlalchemy.url')}")
print(f"ADMIN_USER: {settings.ADMIN_USER}")
