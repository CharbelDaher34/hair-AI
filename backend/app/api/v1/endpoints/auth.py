...
from crud.crud_hr import get_hr_by_email, create_hr as crud_create_hr # Aliased to avoid conflict
...
@router.post("/register", response_model=Token, summary="HR Register and Get Token", status_code=status.HTTP_201_CREATED)
