...
class WorkHistoryItem(BaseModel):
    ...
    employment_type: str = Field(..., description="Type of employment (e.g., Full-time, Part-time).")
    ...
    end_date: Optional[date] = Field(None, description="Job end date, null if currently employed.")
...
class EducationItem(BaseModel):
    ...
    degree_type: str = Field(..., description="Degree name (e.g., BS in Computer Science).")
    subject: str = Field(..., description="Major or field of study.")
    start_date: date = Field(..., description="Start date of the program.")
    end_date: Optional[date] = Field(None, description="End or expected graduation date.")
