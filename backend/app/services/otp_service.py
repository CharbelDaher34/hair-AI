...
from core.config import OTP_EXPIRE_MINUTES, OTP_LENGTH
...
class OTPService:
    def __init__(self):
        ...
        self.expire_minutes = OTP_EXPIRE_MINUTES
    ...
    def is_email_verified(self, email: str) -> bool:
        ...
        if otp_data.get('verified', False) and datetime.utcnow() <= otp_data['expires_at']:
            return True
    ...
    def cleanup_expired_otps(self):
        ...
        expired_emails = [
            email for email, data in self._otp_storage.items()
    ...
    def get_otp_status(self, email: str) -> Dict[str, any]:
        ...
        return {
            ...
            'expires_at': otp_data['expires_at'].isoformat() if not is_expired else None
        }
