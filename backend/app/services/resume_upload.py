...
class AgentClient:
    def __init__(self):
        ...
        """
        if not AI_BASE_URL:
            raise ConnectionError("AI service base URL could not be determined. AgentClient cannot operate.")
        ...
        batch_meta_items = [
            {
                ...
                "schema_str": json.dumps(single_schema), # Reusing schema for simplicity
            ...
            },
            {
                ...
                "schema_str": json.dumps(single_schema),
