...
def check_candidate_exists(
    db: Session, candidate_email: str, phone: str
) -> Optional[str]:
...
def add_candidate_to_employer(
    db: Session, *, candidate_id: int, employer_id: int
) -> bool:
...
def get_candidates_table_by_company(
    db: Session, *, employer_id: int
) -> List[Dict[str, Any]]:
...
def get_candidate_with_details(
    db: Session, candidate_id: int
) -> Optional[CandidateWithDetails]:
    ...
    for application in applications:
        ...
        try:
            ...
            interview_reads = [
                InterviewRead.model_validate(interview) for interview in interviews
            ]
    ...
    return CandidateWithDetails(
        **candidate.model_dump(), applications=applications_with_interviews
    )
